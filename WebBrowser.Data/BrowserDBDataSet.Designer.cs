...
namespace WebBrowser.Data.BrowserDBDataSetTableAdapters {
    ...
    public partial class BookmarkTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Bookmark] WHERE (([Id] = @Original_Id) AND ([URL] = @Original_" +
                "URL) AND ([Title] = @Original_Title))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Bookmark] ([URL], [Title]) VALUES (@URL, @Title);\r\nSELECT Id, " +
                "URL, Title FROM Bookmark WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Bookmark] SET [URL] = @URL, [Title] = @Title WHERE (([Id] = @Origin" +
                "al_Id) AND ([URL] = @Original_URL) AND ([Title] = @Original_Title));\r\nSELECT Id," +
                " URL, Title FROM Bookmark WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, URL, Title FROM dbo.Bookmark";
        ...
        public virtual int Fill(BrowserDBDataSet.BookmarkDataTable dataTable) {
        ...
        public virtual BrowserDBDataSet.BookmarkDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BrowserDBDataSet.BookmarkDataTable dataTable = new BrowserDBDataSet.BookmarkDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BrowserDBDataSet.BookmarkDataTable dataTable) {
